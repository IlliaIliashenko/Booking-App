    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailsEntities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DetailsEntityId = table.Column<int>(type: "int", nullable: false),
                    ApartmentEntityId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Аренда VIP 2-ух комнатной квартиры в Новострое", 9500m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "2d3abd2c-2c1e-4340-96ba-f02c23aab798", "User", "USER" },
                    { 2, "356dec19-5fad-4493-9216-c882eea630f9", "UserWithNoPermission", "USERWITHNOPERMISSION" }
                });

            migrationBuilder.InsertData(
                table: "DetailsEntities",
                columns: new[] { "Id", "Name", "ValueType" },
                values: new object[,]
                {
                    { 1, "Address", "System.String" },
                    { 2, "Floor", "System.Int32" },
                    { 3, "Rooms", "System.Int32" },
                    { 4, "Size", "System.Int32" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Цілиноградська вулиця, 48-в, Харків, Харківська область, 61202" },
                    { 2, 1, 2, "2" },
                    { 3, 1, 3, "2" },
                    { 4, 1, 4, "87" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "ApartmentPhotos/apartment11.jpg" },
                    { 2, 1, "ApartmentPhotos/apartment12.jpg" },
                    { 3, 1, "ApartmentPhotos/apartment13.jpg" }
                });

            migrationBuilder.InsertData(
                table: "AspNetRoleClaims",
                columns: new[] { "Id", "ClaimType", "ClaimValue", "RoleId" },
                values: new object[] { 1, "Booking.Permission", "users.view", 1 });
